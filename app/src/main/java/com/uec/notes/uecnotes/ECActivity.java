...
public class ECActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ec_activity);
        parent=findViewById(R.id.ec_layout);

        list=new ListView(ECActivity.this);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ECActivity.this,"OPENING "+o,Toast.LENGTH_LONG).show();
