...
public class ChemicalActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chme_activity);
        parent=findViewById(R.id.chme_layout);

        list=new ListView(ChemicalActivity.this);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ChemicalActivity.this,"OPENING "+o,Toast.LENGTH_LONG).show();
